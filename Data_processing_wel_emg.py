...
def shujuzengqiang(X_train_padded2, y_train_fenlei):
    ...
    X_train_class_0_augmented = np.concatenate((X_train_class_0_replicated, remainder_0), axis=0)
    ...
    X_train, Y_train = interleave_and_merge2(X_train_class_1_augmented, X_train_class_0_final, X_train_class_2_final,
                                            y_train_class_1_augmented, y_train_class_0_final, y_train_class_2_final)
...
def loading_data2():
    ...
    data_folder_path = r"Features_extracted/Wellbeing_emg"  # First unzip the zip file in the corresponding path
    ...
    labels = csv_data['Label-GWB'].values
    ...
    y_train_class_1_Ag = np.concatenate((y_train_class_1_Ag, y_train_class_1_Ag), axis=0)
    y_train_class_1_Co = np.concatenate((y_train_class_1_Co, y_train_class_1_Co), axis=0)
    ...
    y_train_class_0_Ex_replicated = np.tile(y_train_class_0_Ex, int(replicate_factor_0))
    y_train_class_0_Ag_replicated = np.tile(y_train_class_0_Ag, int(replicate_factor_0))
    y_train_class_0_Co_replicated = np.tile(y_train_class_0_Co, int(replicate_factor_0))
    y_train_class_0_Ne_replicated = np.tile(y_train_class_0_Ne, int(replicate_factor_0))
    y_train_class_0_Op_replicated = np.tile(y_train_class_0_Op, int(replicate_factor_0))
    ...
    y_remainder_0_Ex = y_train_class_0_Ex[:int(replicate_factor_0 % 1 * num_samples_0)]
    y_remainder_2_Ex = y_train_class_2_Ex[:int(replicate_factor_2 % 1 * num_samples_2)]
    y_remainder_0_Ag = y_train_class_0_Ag[:int(replicate_factor_0 % 1 * num_samples_0)]
    y_remainder_2_Ag = y_train_class_2_Ag[:int(replicate_factor_2 % 1 * num_samples_2)]
    y_remainder_0_Co = y_train_class_0_Co[:int(replicate_factor_0 % 1 * num_samples_0)]
    y_remainder_2_Co = y_train_class_2_Co[:int(replicate_factor_2 % 1 * num_samples_2)]
    y_remainder_0_Ne = y_train_class_0_Ne[:int(replicate_factor_0 % 1 * num_samples_0)]
    y_remainder_2_Ne = y_train_class_2_Ne[:int(replicate_factor_2 % 1 * num_samples_2)]
    y_remainder_0_Op = y_train_class_0_Op[:int(replicate_factor_0 % 1 * num_samples_0)]
    y_remainder_2_Op = y_train_class_2_Op[:int(replicate_factor_2 % 1 * num_samples_2)]

    X_train_class_0_augmented = np.concatenate((X_train_class_0_replicated, remainder_0), axis=0)
    X_train_class_2_augmented = np.concatenate((X_train_class_2_replicated, remainder_2), axis=0)
    y_train_class_0_augmented = np.concatenate((y_train_class_0_replicated, y_remainder_0), axis=0)
    y_train_class_2_augmented = np.concatenate((y_train_class_2_replicated, y_remainder_2), axis=0)
    y_train_class_0_Ex_augmented = np.concatenate((y_train_class_0_Ex_replicated, y_remainder_0_Ex), axis=0)
    y_train_class_2_Ex_augmented = np.concatenate((y_train_class_2_Ex_replicated, y_remainder_2_Ex), axis=0)
    y_train_class_0_Ag_augmented = np.concatenate((y_train_class_0_Ag_replicated, y_remainder_0_Ag), axis=0)
    y_train_class_2_Ag_augmented = np.concatenate((y_train_class_2_Ag_replicated, y_remainder_2_Ag), axis=0)
    y_train_class_0_Co_augmented = np.concatenate((y_train_class_0_Co_replicated, y_remainder_0_Co), axis=0)
    y_train_class_2_Co_augmented = np.concatenate((y_train_class_2_Co_replicated, y_remainder_2_Co), axis=0)
    y_train_class_0_Ne_augmented = np.concatenate((y_train_class_0_Ne_replicated, y_remainder_0_Ne), axis=0)
    y_train_class_2_Ne_augmented = np.concatenate((y_train_class_2_Ne_replicated, y_remainder_2_Ne), axis=0)
    y_train_class_0_Op_augmented = np.concatenate((y_train_class_0_Op_replicated, y_remainder_0_Op), axis=0)
    ...
    y_train_class_0_Ex_final = np.hstack((y_train_class_0_Ex, y_train_class_0_Ex_augmented))
    y_train_class_2_Ex_final = np.hstack((y_train_class_2_Ex, y_train_class_2_Ex_augmented))
    y_train_class_0_Ag_final = np.hstack((y_train_class_0_Ag, y_train_class_0_Ag_augmented))
    y_train_class_2_Ag_final = np.hstack((y_train_class_2_Ag, y_train_class_2_Ag_augmented))
    y_train_class_0_Co_final = np.hstack((y_train_class_0_Co, y_train_class_0_Co_augmented))
    y_train_class_2_Co_final = np.hstack((y_train_class_2_Co, y_train_class_2_Co_augmented))
    y_train_class_0_Ne_final = np.hstack((y_train_class_0_Ne, y_train_class_0_Ne_augmented))
    ...
    x_train_z, y_train, y_train_data_Ex, y_train_data_Ag, y_train_data_Co, y_train_data_Ne, y_train_data_Op = interleave_and_merge(X_train_class_1_augmented, X_train_class_0_final,X_train_class_2_final, y_train_class_1_augmented,y_train_class_1_Ex,y_train_class_1_Ag, y_train_class_1_Co,y_train_class_1_Ne,y_train_class_1_Op,
                         y_train_class_0_final,y_train_class_0_Ex_final,y_train_class_0_Ag_final, y_train_class_0_Co_final,y_train_class_0_Ne_final,y_train_class_0_Op_final,
                         y_train_class_2_final,y_train_class_2_Ex_final,y_train_class_2_Ag_final, y_train_class_2_Co_final,y_train_class_2_Ne_final,y_train_class_2_Op_final)
